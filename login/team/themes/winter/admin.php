          ...
          <div class="flex item-1">
            ...
            <table class="table table-dark">
              ...
              while($row = $stmt->fetch()){
                ...
                if($row["USERNAME"] != $_SESSION["4huzhg234lklsdfgu"]){
                  echo '<td><a href="editaccount.php?username='.$row["USERNAME"].'""><i class="material-icons"><img class="add" src="pencil.png"></i></a> ';
                }
                if($row["USERNAME"] != $_SESSION["4huzhg234lklsdfgu"]){
                  echo '<a href="delete.php?username='.$row["USERNAME"].'"><i class="material-icons"><img class="del" src="löschen.png"></i></a></td>';
                }
                echo "</tr>";
              }
               ?>
